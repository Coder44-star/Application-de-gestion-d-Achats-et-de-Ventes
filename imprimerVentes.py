...
chemin_fichier_csv = 'ventes.csv'

# Chemin du fichier Excel de sortie
chemin_fichier_excel = 'donneesVentes.xlsx'
...
def creer_facture(data, chemin_sortie):
    # Création du PDF
    nom_fichier_pdf = os.path.join(chemin_sortie, "factureVentes.pdf")
...
# Ajout des informations de l'entreprise à la facture
    ...
    for row in data:
        for x, cell in enumerate(row):
            ...
            c.drawString(40 + x * 70, y, str(cell))
        y -= 40
...
chemin_fichier_excel = os.path.join(chemin_dossier_script, 'donneesVentes.xlsx')
