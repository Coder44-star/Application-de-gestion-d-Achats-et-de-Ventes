...
chemin_fichier_csv = 'fournisseur.csv'

# Chemin du fichier Excel de sortie
chemin_fichier_excel = 'donneesFournisseurs.xlsx'
...
def creer_facture(data, chemin_sortie):
    # Création du PDF
    nom_fichier_pdf = os.path.join(chemin_sortie, "donneesFournisseurs.pdf")
...
# Dessiner un cadre autour de la page
    ...
    c.setFillColorRGB(0.5, 0.1, 0.1)  # Noir
# Dessiner un rectangle autour du titre
    ...
    c.drawString(titre_x + 5, titre_y + 5, "DONNEES DES FOURNISSEUR JOURNALIERS")
    ...
    code_postal_entreprise = "12345"
     ...
     # Ajouter une photo
    image_path =r"C:\Users\Mega-Pc\OneDrive\Bureau\python1\signiature.jpeg "
...
chemin_fichier_excel = os.path.join(chemin_dossier_script, 'donneesFournisseurs.xlsx')
